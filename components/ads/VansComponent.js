...
export default  function  VansComponent(){
    ...
    const defaultCategory=`${process.env.VAN_ID}`
    const [myFilters, setMyFilters] = useState({
        filters: { category: [defaultCategory], price: [],carBrand:[],district:[],localArea:[],vanBrand:[] }
    });
