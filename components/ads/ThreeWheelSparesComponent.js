...
export default  function  ThreeWheelerSparesComponent(){
    ...
    const defaultCategory=`${process.env.WHEELPARTS_ID}`
      ...
      <div>
              ...
              <div className="row">
                ...
                <h4 className="my-3 "><span class="badge text-bg-secondary">Filter by District</span></h4>
                    ...
                    <h4 className="my-3 "><span class="badge text-bg-secondary">Filter by Part Type</span></h4>
                    <div className="default-checkbox-div">
                        <ul>
                            <CarCheckBox
