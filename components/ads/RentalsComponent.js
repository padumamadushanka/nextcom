...
import { rentalTypes } from '@/utils/vehicles/rentals/vehicleRentalTypes';
import { rentalUnits } from '@/utils/vehicles/rentals/vehicleRentalUnits';
...
export default  function  RentalsComponent(){
    ...
    const defaultCategory=`${process.env.RENT_ID}`
    const [myFilters, setMyFilters] = useState({
        filters: { category: [defaultCategory], price: [],rentalVType:[],district:[],localArea:[],rentalVUnit:[] }
    });
      ...
      <div>
              ...
              <div className="row">
                ...
                <h4 className="my-3 "><span class="badge text-bg-secondary">Filter by District</span></h4>
                    ...
                    <h4 className="my-3 "><span class="badge text-bg-secondary">Filter by Rental Type</span></h4>
                    <div className="default-checkbox-div">
                        <ul>
                            <CarCheckBox
                                categories={rentalTypes}
                                handleFilters={filters =>
                                    handleFilters(filters, "rentalVType")
                                }
                            />
                        </ul>
                        
                    </div>    
                    <h4 className="my-3 "><span class="badge text-bg-secondary">Filter by Rental Unit</span></h4>
                    <div className="default-checkbox-div">
                        <ul>
                            <CarCheckBox
                                categories={rentalUnits}
                                handleFilters={filters =>
                                    handleFilters(filters, "rentalVUnit")
                                }
                            />
                        </ul>
