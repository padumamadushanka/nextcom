...
import { heavyModelsCategory } from '@/utils/vehicles/heavy/heavyModelsCategory';
...
export default  function  HeavyComponent(){
    ...
    const defaultCategory=`${process.env.HEAVY_ID}`
    const [myFilters, setMyFilters] = useState({
        filters: { category: [defaultCategory], price: [],heavyType:[],district:[],localArea:[] }
    });
      ...
      <div>
              ...
              <div className="row">
                ...
                <h4 className="my-3 "><span class="badge text-bg-secondary">Filter by District</span></h4>
                    ...
                    <h4 className="my-3 "><span class="badge text-bg-secondary">Filter by Type</span></h4>
                    <div className="default-checkbox-div">
                        <ul>
                            <CarCheckBox
                                categories={heavyModelsCategory}
                                handleFilters={filters =>
                                    handleFilters(filters, "heavyType")
                                }
                            />
                        </ul>
