...
export default  function  BikesComponent(){
    ...
    const defaultCategory=`${process.env.BIKE_ID}`
    const [myFilters, setMyFilters] = useState({
        filters: { category: [defaultCategory], price: [],bikeBrand:[],district:[],localArea:[] }
    });
...
const apriliaModels=()=>(
   ...
   const harleydavidsonModels=()=>(
    <div>
        <h4>select harley davidson model</h4>
   ...
   const royalEnfieldModels=()=>(
    <div>
        <h4>select royal enfield model</h4>
